...
/* 1. 화살표 함수는 자체적으로 this를 가지지 않는다.(화살표 함수를 호출하나 객체의 의미가 아니다.)*/
/* 객체의 메소드 안에서 동일한 객체의 프로퍼티를 대상으로 콜백함수를 적용할 깨 사용할 수 있다. */
let theater = {
    store: "강남점",
    titles: ["파묘",'Dune2',"윙카","가려운 것들", "포켓몬스터"],
    ...
    showMovieList: function(){
        ...
        this.titles.forEach(
            title => console.log(this.store + ": " + title)     // 윗줄의 this와 같은 this      // 반드시 화살표 함수를 써야 하는 경우도 있다.
        );
...
/*
    ...
    따라서 화살표 함수를 사용할 때는 어느정도 개념을 정확히 인지하고 써야 한다.
 */