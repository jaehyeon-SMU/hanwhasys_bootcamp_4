...
-- user_id를 null로 했을 경우(애러 발생)
INSERT 
  INTO user_notnull
(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
(3, null, 'pass01', '홍길동', '남', '010-1234-5678', 'hong123@gmail.com'),
...
(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
(3, 'user03', 'pass01', '강감찬', '남', '010-777-7777', 'hong123@gmail.com');

SELECT * FROM user_unique;

-- ---------------------------------------------------
-- 3.PRIMARY KEY 제약조건
-- 한 행의 정보를 찾기 위해 사용 할 컬럼을 의미 (중요!)
...
CREATE TABLE IF NOT EXISTS user_grade ( -- user_grade 부모 테이블 
...
CREATE TABLE IF NOT EXISTS user_foreignkey1 (
    ...
    FOREIGN KEY (grade_code) 
		REFERENCES user_grade (grade_code)  -- user_grade가 부모테이블
) ENGINE=INNODB;
...
(user_no, user_id, user_pwd, user_name, gender, phone, email, grade_code)
VALUES
(3, 'user03', 'pass03', '이순신', '남', '010-777-7777', 'yu77@gmail.com', 50);


-- 자식테이블에서 foreign key 제약조건 컬럼 null값으로 insert(이 행은 부모와 관련이 없다.)

INSERT 
  INTO user_foreignkey1
(user_no, user_id, user_pwd, user_name, gender, phone, email, grade_code)
VALUES
(3, 'user03', 'pass03', '이순신', '남', '010-777-7777', 'yu77@gmail.com', NULL);
...
SELECT * FROM user_grade;
DELETE FROM user_grade WHERE grade_code = 20; -- user_foreginkey1 테이블은 삭제룰을 적용하지 않고 20을 참조한 데이터가 있다.
