...
public class User {
    ...
    * */
    ...
    /* 필기. 생성자와 같은 클래스 내부에 거의 필수적으로 들어가는 요소를 생성하는 단축키는 alt + insert이다. */
    ...
    public User(String id, String pwd, String name, Date enrollDate) {
        ...
        /* 필기. 일반적으로 필드의 변수명과 매개변수명이 동일하므로 반드시 this.을 명시해야 합니다. */
...
//        this(id,pwd,name);        다른 생성자를 활용하는 구문(this())는 반드시 먼저 명시되어야 한다 <<시험 가능>>
