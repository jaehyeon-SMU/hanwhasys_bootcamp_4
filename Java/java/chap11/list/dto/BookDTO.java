...
public class BookDTO implements Comparable<BookDTO> {
    ...
    *   필드가 4개면 총 8가지의 정렬 기준을 가질 수 있다.(각각 오름차순 or 내림차순이 가능하므로)
    *   정렬은 compareTo메소드가 반환하는 int형의 부호에 따라 정해지게 되며 부호가 반대로 되면 오름차순과
    *   내림차순의 개념이 반대로 된다.
...
//        return this.price - ((BookDTO)o).price;     // 서로 가격을 뺐을때, 차이는 중요하지 않고, 음수인지 양수인지 0인지만 중요
//        return ((BookDTO)o).price - this.price;     // 내림차순으로 바꾸기1
//        return -(this.price - ((BookDTO)o).price);    // 내림차순으로 바꾸기2
