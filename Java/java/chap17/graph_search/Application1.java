...
public class Application1 {
    ...
    static boolean[] visit;     // 방문 개념
    static int[][] map;
    static int count = 0;
    static int node,edge;

    /* 설명. 테스트 코드에서 입력 받는 방식을 문제에서 요구하는 대로 작성하고 문자열로 입력받기 위해 변경 된 코드 */
    ...
    public static Integer solution(String input) throws IOException {
        ...
        /* 설명. 방문 배열 작성(방문 배열을 작성하는 이유: 방문했던 노드를 다시 stack에 담지 않거나 다시 재귀 함수 호출을 하지 않기 위함이다. */
        visit = new boolean[node + 1];          // 방문 배열도 노드 번호와 인덱스 번호를 일치시키기 위해서 1 증가
