...
public class Application2 {
    public static void main(String[] args) {
        ...
        System.out.println(1.23 / 10.0);
        System.out.println(1.23 % 1.0);             // 필기. 실수는 정확하지 않고 근사값이다.
        ...
        System.out.println("hello" + "world!");  // 필기. 문자열간의 연산은 덧셈만 가능
        ...
        // 설명. 문자열 뒤에 숫자를 활용한 연산을 쓰게 되면 소괄호(())를 써서 우선순위를 높이고 연산해주어야 한다.
        System.out.println("합계: "+ (123 + 456));

        // 목차. 4. 논리값의 연산
        // 설명. 대부분의 연산이 적용되지 ㅇ낳고 논리와 문자열의 연산만 가능하다.

        System.out.println("====================== 논리값과 문자열 형태의 값 연산 =================");
        // System.out.println(true + 1);           컴파일 오류
