    ...
    public static void main(String[] args) throws Exception {
        ...
        * */
        ...
        try {
            ...
            /* 설명. catch 구문으로 처리할 예외가 발생하는 부분을 try구문으로 묶을 수 있다.(범위는 너무 크지 않게 적당히 지정할 것(관련있는 것만)) */
