...
public class AssertJTests {
    ...
    /* 수업목표. test third party lib 중 AssertJ 사용법 이해 */

    /* 목차. 1) 문자열 테스트 하기 */
    /* 필기. 문자열의 패턴들로 검증을 하기 때문에 일치성 여부만 판단하는 것보다 다양한 테스트 가능 */
    @Test
    ...
    /* 목차. 2) 숫자 테스트 */
    /* 필기. 숫자 또한 일치여부가 아닌 범위값도 검증한느 단정문(메소드)을 통해 다양한 테스트 수행 가능 */
    @Test
    @DisplayName("숫자 테스트")
    ...
    /* 목차. 3) 날짜 테스트 */
    /* 필기. 날짜 객체가 가지는 년, 월, 일, 시, 분, 초, 밀리초, 나노초까지도 검증 가능, 특정 날짜 범위, 이전, 이후 내용도 검증 가능 */
    @Test
    @DisplayName("날짜 테스트")
    ...
    /* 목차. 4) 예외 테스트 */
    /* 필기. 예외 내용 검증하는 것 또한 예외 타입, 예외 메시지 등 검증 가능 */
    @Test
    @DisplayName("예외 테스트")
    ...
    /* 필기. 특정 filter를 자바 람다식으로 표현할 수 있는 유용한 기능 */
    @Test
    ...
    void testFilteringAssertions() {
        ...
        Member member4 = new Member(4, "user04", "심사임당", 43);
        Member member5 = new Member(5, "user05", "임꺽정", 18);
    ...
    /* 목차. 6) 객체 프로퍼티 검증하기 */
    /* 필기. 객체의 프로퍼티를 추출하여 filter 가능 -> getter 함수 없어도 프로퍼티 필터링 가능 */
    @Test
    @DisplayName("객체의 프로퍼티 검증 테스트")
