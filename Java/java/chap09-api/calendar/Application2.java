...
//        Calendar cal = new Calendar();
        ...
        System.out.println("태어난 월: " + birthDay.get(2) + 1);        //get() 메소드로 반환받은 값에 +1 해줘야 우리가 생각하는 월의 개념이 된다.
        ...
        System.out.println("내 생일은 " + day + "요일이지롱!");
        ...
        /* 설명. SimpleDateFormat 활용하기 */
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd hh:mm:ss E요일");
        String birthDatyString = sdf.format(new java.util.Date(birthDay.getTimeInMillis()));
        System.out.println("birthDatyString = " + birthDatyString);
    }
}
