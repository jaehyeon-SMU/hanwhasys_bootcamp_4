...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        bookList.add(new BookDTO(5,"해리포터","롤링",90000));

//        for (int i = 0; i < bookList.size(); i++) {
//            System.out.println(bookList.get(i));
//        }

        /* 설명. Collections가 제공하는 sort 사용시 */
//        Collections.sort(bookList);             // BookDTO에 compareTo 오버라이딩을 price 필드값을 기준으로했기 때문에 price로 오름차순 정리
//        Collections.sort(bookList, new AscendingPrice());
        Collections.sort(bookList, new DescendingAuthor());

        /* 설명. ArrayList가 제공하는 sort 사용시 (Comparator 기준만 가능) */
