...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        int autoUnvoxingValue = autoBoxingInt;

        anythingMethod(10);

        /* 설명. Wrapper 클래스 값 비교 */
        /* 설명. Wrapper 클래스들도 리터럴(literal)값으로 오토박싱하면 결국 동일한 객체 하나만 관맇나다. */
        ...
        System.out.println("integerTest의 주소: " + System.identityHashCode(integerTest));
        System.out.println("integerTest2의 주소: " + System.identityHashCode(integerTest2));
    }
