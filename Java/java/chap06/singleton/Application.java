...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *    인스턴스가 하나만 생성되어 공유되게 하는 것을 싱글톤 패턴이라고 한다.
        *    (메모리 낭비 방지 목적)
        *
        *   필기.
        *    장점
        ...
        *    2. 동시성 문제를 고려해서 설계해야 하기 때문에 난이도 가 높다.
        *
        *   필기.
        *    싱글톤 구현 방법
        ...
        *   처음 인스턴스 반환 요정에서 속도가 빠르다는 장점을 가진다.
        *   반면, 늦은 초기화는 클래스는 로드하는 속도는 빠르지만 첫번째 요청에 대한 속도가 두 번째 요청에
        *   대한 속도보다는 느리다는 특징을 가지고 있다.
        * */
