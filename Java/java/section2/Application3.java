package com.ohgiraffers.section02.variavle;
...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        *    실무적으로는 굉장히 중요하기 때문에 반딋 숙지해야 한다.
        *    또한, 규칙에 맞는 올바른 변수명을 짓는 것이 좋은 프로그래밍을 하는 첫 단계이다.
        ...
        int aGe = 20;           //필기. 위에서 만든 age와 다른 변수로 취급
        ...
        /* 목차. 2. 컴파일 에러를 발생시키지는 않지만 개발자간의 암묵적인 규칙( 관례상 규칙) */
        /* 목차. 2-1. 변수명의 길이 제한은 없다. 하지만 적당히 하자.*/
        int dsjflkajeilfawekfkaejflkwejfklawelkfj;
