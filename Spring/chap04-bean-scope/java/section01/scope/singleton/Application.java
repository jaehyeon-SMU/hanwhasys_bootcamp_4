...
public class Application {
    ...
    *    4. session: 세션 당 하나의 인스턴스를 생성하고, 세션이 종료되면 인스턴스를 폐기한다.
    *                웹 애플리케이션 컨텍스트에만 해당된다.
    ...
    * */
    ...
    public static void main(String[] args) {
        ...
        /* 설명. 붕어빵, 딸기우유, 삼다수 빈 객체를 반환받아 변수에 담는다. */
        ...
        System.out.println(System.identityHashCode(cart1) == System.identityHashCode(cart2));       //singleton임을 알 수 있다.
    }
}
