...
public class Application {
    ...
    private static void trimSubMenu() {
        ...
        do{
            ...
            System.out.println("2. 메뉴 혹은 카테고리로 검색, 단, 메뉴와 카테고리 둘 다 일치하는 경우도 검색하며,검색 족선이 없는 경우 전체 검색");
    ...
    private static SearchCriteria inputAllOrOne(){
        Scanner sc = new Scanner(System.in);
        System.out.print("검색 조건을 입력하실라유?(예 or 아니요): ");
    ...
    /* 설명. SearchCriteria(condition 과 value의 묶음) 개념을 이번에는 DTO가 아닌 MAP으로 작성해보자 */
